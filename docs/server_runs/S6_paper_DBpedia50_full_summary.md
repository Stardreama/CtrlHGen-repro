...
The paper-supervised DBpedia50 full run uses a training setup closer to the paper than S6: 400 unconditional epochs, 50 pattern-conditional epochs, batch size 256, learning rate 1e-5, and separate optimizer/scheduler warm-up for the pattern stage. Full rerank improves all tracked main metrics over the paper-supervised baseline.
